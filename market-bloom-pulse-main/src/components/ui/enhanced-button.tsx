  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        hero: "btn-hero",
        glass: "btn-glass",
        gradient: "bg-gradient-primary text-primary-foreground font-semibold shadow-elegant hover-lift hover-glow transition-spring",
        "gradient-secondary": "bg-gradient-secondary text-secondary-foreground font-semibold shadow-elegant hover-lift hover-glow transition-spring",
      },
      size: {
